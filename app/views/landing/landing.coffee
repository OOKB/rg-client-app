      ...
      id: 'landing',
        ...
        div
          ...
          className: noticeBoxClassName,
            a {href: '#favs/750002-31/750002-32'},
              img
                src: 'http://rogersandgoffigon.imgix.net/banner/20180514-SkyePinkBlush.jpg?w=999'
                alt: 'Introducing Skye in two new shades of pink'
          button
            className: 'close'
